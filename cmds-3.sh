...
ssh 172.16.0.16 "$cmd"
echo "ssh 172.16.0.14"
ssh 172.16.0.14 "$cmd"
echo "ssh 172.16.0.20"
ssh 172.16.0.20 "$cmd"
echo "ssh 172.16.0.12"
ssh 172.16.0.12 "$cmd"
...
ssh 172.16.0.14 "ulimit -n 20000;cd D2PC;bash r0.sh $nServers 2 $nShardsPerShards $keys"
ssh 172.16.0.20 "ulimit -n 20000;cd D2PC;bash r1.sh $nServers 2 $nShardsPerShards $keys"
ssh 172.16.0.12 "ulimit -n 20000;cd D2PC;bash r2.sh $nServers 2 $nShardsPerShards $keys"
