...
ssh 127.0.0.1 "ulimit -n 20000;cd D2PC;bash r0.sh $nServers 8 $nShardsPerShards $keys"
ssh 127.0.0.1 "ulimit -n 20000;cd D2PC;bash r1.sh $nServers 8 $nShardsPerShards $keys"
ssh 127.0.0.1 "ulimit -n 20000;cd D2PC;bash r2.sh $nServers 8 $nShardsPerShards $keys"
ssh 127.0.0.1 "ulimit -n 20000;cd D2PC;bash r0.sh $nServers 9 $nShardsPerShards $keys"
ssh 127.0.0.1 "ulimit -n 20000;cd D2PC;bash r1.sh $nServers 9 $nShardsPerShards $keys"
ssh 127.0.0.1 "ulimit -n 20000;cd D2PC;bash r2.sh $nServers 9 $nShardsPerShards $keys"
...
ssh 127.0.0.1     "ulimit -n 20000;cd D2PC;bash clients.sh 24 $nServers 8 $nShardsPerShards $keys" &
ssh 127.0.0.1     "ulimit -n 20000;cd D2PC;bash clients.sh 25 $nServers 8 $nShardsPerShards $keys" &
ssh 127.0.0.1     "ulimit -n 20000;cd D2PC;bash clients.sh 26 $nServers 8 $nShardsPerShards $keys" &
ssh 127.0.0.1     "ulimit -n 20000;cd D2PC;bash clients.sh 27 $nServers 9 $nShardsPerShards $keys" &
ssh 127.0.0.1     "ulimit -n 20000;cd D2PC;bash clients.sh 28 $nServers 9 $nShardsPerShards $keys" &
ssh 127.0.0.1     "ulimit -n 20000;cd D2PC;bash clients.sh 29 $nServers 9 $nShardsPerShards $keys" &
